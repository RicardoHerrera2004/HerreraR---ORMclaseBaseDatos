...
namespace HerreraR___ORMclaseBaseDatos.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public CarrerasController(SQL_ServerContext context)
        {
            _context = context;
        }
        ...
        {
            var sQL_ServerContext = _context.Carrera.Include(c => c.Facultad);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,FacultadId")] Carrera carrera)
        {
            ...
            ViewData["FacultadId"] = new SelectList(_context.Facultad, "Id", "Nombre", carrera.FacultadId);
            return View(carrera);
        }
